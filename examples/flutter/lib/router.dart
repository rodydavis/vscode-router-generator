...
// "/about/guest": RootPage > GuestPage
// "/about/:id": RootPage > AccountPage
// "/about/": RootPage > AboutDetails
...
import "pages/settings.dart" as route0;
import "pages/about/guest.dart" as route1;
import "pages/about/:id.dart" as route2;
import "pages/about/index.dart" as route3;
import "pages/about.dart" as route4;
import "pages/index.dart" as route5;
import "pages/root.dart" as route6;
...
class _GeneratedAppState extends State<GeneratedApp> {
  ...
  void initState() {
    super.initState();
    pages['/settings'] = route0.SettingsPage();
    pages['/about/guest'] = route1.GuestPage();
    pages['/about/:id'] = route2.AccountPage();
    pages['/about/'] = route3.AboutDetails();
    pages['/about'] = route4.AboutPage();
    pages['/'] = route5.HomePage();
    pages[''] = route6.RootPage();
  ...
  Widget build(BuildContext context) {
    return NotificationListener<_RoutingRequest>(
      ...
      child: MaterialApp.router(
          ...
          title: 'flutter_file_based_routing',
          key: ValueKey(route),
